...
public class CharacterController2D : MonoBehaviour
{
	...
	/// <summary>
	/// this should be called anytime you have to modify the CircleCollider2D at runtime. It will recalculate the distance between the rays used for collision detection.
	...
	/// <summary>
	/// checks the center point under the CircleCollider2D for a slope. If it finds one then the deltaMovement is adjusted so that
